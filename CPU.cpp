...
case 0x86: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 0)); clock += 16; } break;
...
case 0x8E: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 1)); clock += 16; } break;
...
case 0x96: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 2)); clock += 16; } break;
...
case 0x9E: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 3)); clock += 16; } break;
...
case 0xA6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 4)); clock += 16; } break;
...
case 0xAE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 5)); clock += 16; } break;
...
case 0xB6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 6)); clock += 16; } break;
...
case 0xBE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val & ~(1 << 7)); clock += 16; } break;
...
case 0xC6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 0)); clock += 16; } break;
...
case 0xCE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 1)); clock += 16; } break;
...
case 0xD6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 2)); clock += 16; } break;
...
case 0xDE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 3)); clock += 16; } break;
...
case 0xE6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 4)); clock += 16; } break;
...
case 0xEE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 5)); clock += 16; } break;
...
case 0xF6: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 6)); clock += 16; } break;
...
case 0xFE: { uint8_t val = Mem.read(R.get_HL()); Mem.write(R.get_HL(), val | (1 << 7)); clock += 16; } break;
...
case 0x06: { uint16_t hl = R.get_HL(); Mem.write(hl, rlc_op(Mem.read(hl))); clock += 16; } break;
...
case 0x0E: { uint16_t hl = R.get_HL(); Mem.write(hl, rrc_op(Mem.read(hl))); clock += 16; } break;
...
case 0x16: { uint16_t hl = R.get_HL(); Mem.write(hl, rl_op(Mem.read(hl))); clock += 16; } break;
...
case 0x1E: { uint16_t hl = R.get_HL(); Mem.write(hl, rr_op(Mem.read(hl))); clock += 16; } break;
...
case 0x26: { uint16_t hl = R.get_HL(); Mem.write(hl, sla_op(Mem.read(hl))); clock += 16; } break;
...
case 0x2E: { uint16_t hl = R.get_HL(); Mem.write(hl, sra_op(Mem.read(hl))); clock += 16; } break;
...
case 0x36: { uint16_t hl = R.get_HL(); Mem.write(hl, swap_op(Mem.read(hl))); clock += 16; } break;
...
case 0x3E: { uint16_t hl = R.get_HL(); Mem.write(hl, srl_op(Mem.read(hl))); clock += 16; } break;
